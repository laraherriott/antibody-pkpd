...
plt.show()
#fig3.savefig('detailed_model/per_second/noAb_plasma_ab_adcp_0000036.png')
...
plt.ylabel("Species, nM")
plt.show()
#fig7.savefig('detailed_model/per_second/noAb_brainAb_adcp_0000036.png')
...
plt.show()
#fig9.savefig('detailed_model/per_second/noAb_totalPlaque_adcp_0000036.png')
