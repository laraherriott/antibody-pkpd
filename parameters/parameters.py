...
class MITParams:
    def __init__(self):
        ...
        # from good initial estimates, fitted to lecanemab PK and total plaque fall
        self.k_in = 0.000055847
        self.k_clear_Abeta = 0.000049976
        self.k_clear_olig = 0.00000022805
        self.k_clear_P = 0.00000000081594
        self.k_synth_FcR = 0.00019348
        self.k_clear_FcR = 0.00018406
        self.k_onPP = 0.001 # fixed
        self.k_onPD = 0.001 # fixed
        self.k_onPF = 0.001 # fixed
        self.k_olig_inc = 0.000019116
        self.k_olig_sep = 0.000000036912
        self.k_plaque_inc = 0.00000068749
        self.k_plaque_sep = 0.00000028384
        self.k_ADCP = 0.00345334
        self.k_mAbcomplex_clear = 0.00000014504
        self.mAb_transport = 0.0000036971
        self.mAb_transport_back = 0.00318675
        self.clearance = 0.000010651

        # lecanemab - fixed
        self.k_off_ma0 = 2.29
        self.k_off_ma1 = 0.0673
        self.k_off_ma2 = 0.00179
        self.k_offPF = 0.00012
