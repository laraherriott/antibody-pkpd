...
tspan = np.arange(0, (24*100), 1)
df = pd.read_csv('PK_results.csv')
data = df['PK'].values
...
times3 = [t for t in times2]

initmAb = 0

result = minimize(error, params, args=(initmAb, tspan, data2, dose_list), method='leastsq')
