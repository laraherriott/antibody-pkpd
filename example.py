...
model = LecanemabModel(model_type, 10, (14*24), (24*100), median_patient=True, param_type = 'noiiv')
model()
...
solver = Solution(model, 0, (24*100), 1) # 12960 hours = 18 months; 1080 half days
...
nM = []
for i in central_L:
    nM.append(((((i)/1000/3.22)/147181.62))*1e9)
...
df['PK'] = nM
df['time'] = time
df.to_csv('PK_fit_data.csv')



plt.plot(time, nM, label="Central compartment")
